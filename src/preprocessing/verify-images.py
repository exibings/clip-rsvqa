...
print("\tall original images?", True if len(os.listdir("datasets/RSVQA-LR/images")) == 772+1 else False)
print("\tall resized images?", True if len(os.listdir("datasets/RSVQA-LR/images/resized")) == 772 else False)


print("Verifying RSVQA-HR images...")
print("\tall original images?", True if len(os.listdir("datasets/RSVQA-HR/images")) == 10659+1 else False)
print("\tall resized images?", True if len(os.listdir("datasets/RSVQA-HR/images/resized")) == 10659 else False)
...
total = 0
total_resized = 0
for subfolder in os.listdir("datasets/RSVQAxBEN/images"):
...
for subfolder in os.listdir("datasets/RSVQAxBEN/images/resized"):
    images_checker_resized[subfolder] = 0
    images_checker_resized[subfolder] = len(os.listdir(os.path.join("datasets/RSVQAxBEN/images", subfolder)))
